                ...
                <li className='nav'>
                    ...
                    {!getCurrentUser() ? (
                        ...
                        <div className='userOptions'>
                            ...
                            <p onClick={logoutUser} className='navItem3'>Logout</p></div>
                        ...
                        <div className='calendar'>
                            {tickets && tickets.map((ticket, index) =>
                                <button id={index}
                                    ...
                                    <p id={`${index}date`}
                                        className='date'>{ticket.day}</p>
                                    <div className='days'>
                                        <p id={`${index}day1`}
                                            className='day '>{ticket.month}</p>
                                        <p id={`${index}day2`}
                                            className='day '>{ticket.weekDay}</p>
                                    </div>
                                </button>
                            )}
                        </div>
                        ...
                        <div className='ticketTimes'>
                            {chosen.sans.map((time, index) => {
                                ...
                                return <div className='history'>
                                    ...
                                    {movies && movies[time.time] && <img className='historyPoster'
                                        src={`${url}${movies[time.time].id}/${movies[time.time].poster}`}
                                        alt="Movie Poster" />}
                                </div>
                            })}
                        </div>
